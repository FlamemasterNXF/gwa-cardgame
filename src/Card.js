...
cardsData[4] = new Card(false,`common test`, `A baby gwa. You start with this card!`, `Single-Target, Summoning`, 96, `gwaling Roll: Deal 10 DMG to target.<br>gwaling Cry: Summon another gwaling. 3 turn cooldown.`, `Common`, 80)
//rares
cardsData[1] = new Card(false,`gwasanta`, `A gwa wearing a Santa hat. Strange.`, `Single-Target, Healing`,96, `Angry Gift: Deal 5 DMG to target for every allie card defeated.<br>Loving Gift: Destroy gwasanta but Revive a defeated allie card. This attack starts on a 5 card cooldown.`, `Rare`, 20)
//mythicals
